...
class LocationsBeta(BaseResource):
    ...
    async def archive_locations(
        self, body: ArchiveLocationRequest, *, mode: Literal["pydantic"] = "pydantic"
    ) -> list[ArchiveLocationResponse]: ...
    @overload
    async def archive_locations(
        self, body: ArchiveLocationRequest, *, mode: Literal["dict"]
    ) -> list[dict[str, Any]]: ...
    @overload
    async def archive_locations(self, body: ArchiveLocationRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def archive_locations(
        self, body: ArchiveLocationRequest, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
    ...
    async def create_locations(
        self, body: list[CreateLocation], *, mode: Literal["pydantic"] = "pydantic"
    ) -> list[Location]: ...
    @overload
    async def create_locations(self, body: list[CreateLocation], *, mode: Literal["dict"]) -> list[dict[str, Any]]: ...
    @overload
    async def create_locations(self, body: list[CreateLocation], *, mode: Literal["raw"]) -> httpx.Response: ...
    async def create_locations(
        self, body: list[CreateLocation], *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
        ...
        resp = await self._request("POST", "/sd/locations", json=[self.dump_json(x) for x in body])
