...
class ProductRecommendationService(BaseResource):
    ...
    async def get_product_recommendations(
        self, body: GetProductRecommendationsRequest, *, mode: Literal["pydantic"] = "pydantic"
    ) -> ProductRecommendationsByASIN: ...
    @overload
    async def get_product_recommendations(
        self, body: GetProductRecommendationsRequest, *, mode: Literal["dict"]
    ) -> dict[str, Any]: ...
    @overload
    async def get_product_recommendations(
        self, body: GetProductRecommendationsRequest, *, mode: Literal["raw"]
    ) -> httpx.Response: ...
    async def get_product_recommendations(
        self, body: GetProductRecommendationsRequest, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
