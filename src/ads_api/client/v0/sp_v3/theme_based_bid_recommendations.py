"""ThemeBasedBidRecommendations resource operations.

Generated from OpenAPI spec (tag: Theme-based bid recommendations).
"""
...
from ads_api.models.v0.sp_v3.theme_based_bid_recommendations import (
    ThemeBasedBidRecommendationResponse,
)


class ThemeBasedBidRecommendations(BaseResource):

    @overload
    async def get_theme_based_bid_recommendation_for_ad_group_v1(
        self, *, mode: Literal["pydantic"] = "pydantic"
    ) -> ThemeBasedBidRecommendationResponse: ...
    @overload
    async def get_theme_based_bid_recommendation_for_ad_group_v1(self, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
    async def get_theme_based_bid_recommendation_for_ad_group_v1(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def get_theme_based_bid_recommendation_for_ad_group_v1(
        self, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
    ) -> ThemeBasedBidRecommendationResponse | dict[str, Any] | httpx.Response:
        ...
        return self._response(ThemeBasedBidRecommendationResponse, resp, mode=mode)
