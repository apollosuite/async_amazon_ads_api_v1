...
class MmmReports(BaseResource):
    ...
    @overload
    async def create_mmm_report(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    async def create_mmm_report(self, *, mode: Literal["pydantic"]) -> MmmReport: ...
    @overload
    ...
    @overload
    async def delete_mmm_report(self, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    async def delete_mmm_report(self, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    async def delete_mmm_report(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def delete_mmm_report(self, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
    ...
    @overload
    async def get_mmm_report(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    async def get_mmm_report(self, *, mode: Literal["pydantic"]) -> MmmReport: ...
    @overload
    ...
    @overload
    async def list_mmm_reports(self, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    async def list_mmm_reports(self, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    async def list_mmm_reports(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def list_mmm_reports(self, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
