...
class AdGroups(BaseResource):
    ...
    async def create_sponsored_brands_ad_groups(
        self, body: CreateSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["pydantic"] = "pydantic"
    ) -> CreateSponsoredBrandsAdGroupsResponseContent: ...
    @overload
    async def create_sponsored_brands_ad_groups(
        self, body: CreateSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["dict"]
    ) -> dict[str, Any]: ...
    @overload
    async def create_sponsored_brands_ad_groups(
    ...
    async def create_sponsored_brands_ad_groups(
        self,
        body: CreateSponsoredBrandsAdGroupsRequestContent,
        *,
    ...
    async def delete_sponsored_brands_ad_groups(
        self, body: DeleteSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["pydantic"] = "pydantic"
    ) -> DeleteSponsoredBrandsAdGroupsResponseContent: ...
    @overload
    async def delete_sponsored_brands_ad_groups(
        self, body: DeleteSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["dict"]
    ) -> dict[str, Any]: ...
    @overload
    async def delete_sponsored_brands_ad_groups(
        self, body: DeleteSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["raw"]
    ) -> httpx.Response: ...
    async def delete_sponsored_brands_ad_groups(
        self,
        body: DeleteSponsoredBrandsAdGroupsRequestContent,
        *,
        mode: Literal["pydantic", "dict", "raw"] = "pydantic",
    ...
    async def list_sponsored_brands_ad_groups(
        self, body: ListSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["pydantic"] = "pydantic"
    ) -> ListSponsoredBrandsAdGroupsResponseContent: ...
    @overload
    async def list_sponsored_brands_ad_groups(
        self, body: ListSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["dict"]
    ) -> dict[str, Any]: ...
    @overload
    async def list_sponsored_brands_ad_groups(
        self, body: ListSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["raw"]
    ) -> httpx.Response: ...
    async def list_sponsored_brands_ad_groups(
        self, body: ListSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
    ...
    async def update_sponsored_brands_ad_groups(
        self, body: UpdateSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["pydantic"] = "pydantic"
    ) -> UpdateSponsoredBrandsAdGroupsResponseContent: ...
    @overload
    async def update_sponsored_brands_ad_groups(
        self, body: UpdateSponsoredBrandsAdGroupsRequestContent, *, mode: Literal["dict"]
    ) -> dict[str, Any]: ...
    @overload
    async def update_sponsored_brands_ad_groups(
    ...
    async def update_sponsored_brands_ad_groups(
        self,
        body: UpdateSponsoredBrandsAdGroupsRequestContent,
        *,
        mode: Literal["pydantic", "dict", "raw"] = "pydantic",
