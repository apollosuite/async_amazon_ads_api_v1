...
class AdvertiserAccounts(BaseResource):
    ...
    async def create_advertiser_account(
        ...
        resp = await self._request("POST", "/adsApi/v1/create/advertiserAccounts", json=self.dump_json(body))
    ...
    async def query_advertiser_account(
        ...
        resp = await self._request("POST", "/adsApi/v1/query/advertiserAccounts", json=self.dump_json(body))
    ...
    async def update_advertiser_account(
        ...
        resp = await self._request("POST", "/adsApi/v1/update/advertiserAccounts", json=self.dump_json(body))
        return self._response(AdvertiserAccountMultiStatusResponse, resp, mode=mode)
