...
class DSPGeoLocations(BaseResource):
    ...
    async def create_geo_location(
        self, body: DSPCreateGeoLocationRequest, *, mode: Literal["pydantic"] = "pydantic"
    ) -> DSPGeoLocationMultiStatusResponse: ...
    @overload
    async def create_geo_location(
        self, body: DSPCreateGeoLocationRequest, *, mode: Literal["dict"]
    ) -> dict[str, Any]: ...
    @overload
    async def create_geo_location(
    ...
    async def create_geo_location(
        self, body: DSPCreateGeoLocationRequest, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
