...
class STAds(BaseResource):
    ...
    @overload
    async def create_ad(
        self, body: STCreateAdRequest, *, mode: Literal["pydantic"] = "pydantic"
    ) -> STAdMultiStatusResponse: ...
    @overload
    async def create_ad(self, body: STCreateAdRequest, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
    async def create_ad(self, body: STCreateAdRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def create_ad(
        self, body: STCreateAdRequest, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
    ...
    @overload
    async def delete_ad(
        self, body: STDeleteAdRequest, *, mode: Literal["pydantic"] = "pydantic"
    ) -> STAdMultiStatusResponse: ...
    @overload
    async def delete_ad(self, body: STDeleteAdRequest, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
    async def delete_ad(self, body: STDeleteAdRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def delete_ad(
        self, body: STDeleteAdRequest, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
    ) -> STAdMultiStatusResponse | dict[str, Any] | httpx.Response:
        """Delete ads"""
    ...
    @overload
    async def query_ad(
        self, body: STQueryAdRequest, *, mode: Literal["pydantic"] = "pydantic"
    ) -> STAdSuccessResponse: ...
    @overload
    async def query_ad(self, body: STQueryAdRequest, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
    async def query_ad(self, body: STQueryAdRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def query_ad(
        self, body: STQueryAdRequest, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
    ...
    @overload
    async def update_ad(
        self, body: STUpdateAdRequest, *, mode: Literal["pydantic"] = "pydantic"
    ) -> STAdMultiStatusResponse: ...
    @overload
    async def update_ad(self, body: STUpdateAdRequest, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
    async def update_ad(self, body: STUpdateAdRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def update_ad(
        self, body: STUpdateAdRequest, *, mode: Literal["pydantic", "dict", "raw"] = "pydantic"
    ) -> STAdMultiStatusResponse | dict[str, Any] | httpx.Response:
        """Update ads"""
