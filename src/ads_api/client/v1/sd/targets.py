...
class SDTargets(BaseResource):
    ...
    @overload
    async def create_target(self, body: SDCreateTargetRequest, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
    ...
    @overload
    async def delete_target(self, body: SDDeleteTargetRequest, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
    ...
    @overload
    async def query_target(self, body: SDQueryTargetRequest, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
    ...
    @overload
    async def update_target(self, body: SDUpdateTargetRequest, *, mode: Literal["dict"]) -> dict[str, Any]: ...
    @overload
