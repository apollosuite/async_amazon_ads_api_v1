...
class SponsoredProductsAdEligibilityError(LenientModel):
    ...
    reason: Annotated[
        SponsoredProductsAdEligibilityErrorReason | str, lenient_enum(SponsoredProductsAdEligibilityErrorReason)
    ]
...
class SponsoredProductsAdServingStatusDetail(LenientModel):
    ...
    name: (
        Annotated[SponsoredProductsAdServingStatusReason | str, lenient_enum(SponsoredProductsAdServingStatusReason)]
        | None
    ) = Field(default=None)
...
class SponsoredProductsAsinOwnershipError(LenientModel):
    ...
    message: str = Field(description="Human readable error message")
    reason: Annotated[
        SponsoredProductsAsinOwnershipErrorReason | str, lenient_enum(SponsoredProductsAsinOwnershipErrorReason)
    ]
...
class SponsoredProductsProductAdExtendedData(LenientModel):
    ...
    servingStatus: (
        Annotated[SponsoredProductsAdServingStatus | str, lenient_enum(SponsoredProductsAdServingStatus)] | None
    ) = Field(default=None)
...
class SponsoredProductsProductIdentifierError(LenientModel):
    ...
    message: str = Field(description="Human readable error message")
    reason: Annotated[
        SponsoredProductsProductIdentifierErrorReason | str, lenient_enum(SponsoredProductsProductIdentifierErrorReason)
    ]
...
class SponsoredProductsUnsupportedOperationError(LenientModel):
    ...
    message: str = Field(description="Human readable error message")
    reason: Annotated[
        SponsoredProductsUnsupportedOperationErrorReason | str,
        lenient_enum(SponsoredProductsUnsupportedOperationErrorReason),
    ]
