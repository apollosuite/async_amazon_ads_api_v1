...
class ReportRequest(StrictModel):
    ...
    tactic: Annotated[TacticReport, lenient_enum(TacticReport)] | None = Field(default=None)
    segment: Annotated[Segment, lenient_enum(Segment)] | None = Field(default=None)
...
class ReportResponse(LenientModel):
    ...
    recordType: str | None = Field(default=None, description="The type of report requested.")
    status: str | None = Field(default=None, description="The build status of the report.")
