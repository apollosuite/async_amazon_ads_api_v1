"""Auto-generated models for Account from Amazon Ads API v0."""
...
class AmazonSeller(StrictModel):
...
class AmazonVendor(StrictModel):
...
class CountryCodeToErrorListMap(LenientModel):
    pass
...
class GetAccountResponseContent(LenientModel):
    adsAccount: AdsAccountWithMetaData | None = Field(default=None)


class ListAdsAccountsRequestContent(StrictModel):
...
class ListAdsAccountsResponseContent(LenientModel):
    adsAccounts: list[AdsAccountWithMetaData] | None = Field(default=None, min_length=0, max_length=100)
    nextToken: str | None = Field(default=None)


class RegisterAdsAccountRequestContent(StrictModel):
...
class RegisterAdsAccountResponseContent(LenientModel):
