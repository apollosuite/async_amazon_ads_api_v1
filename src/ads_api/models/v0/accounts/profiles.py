...
class AccountInfo(StrictModel):
    ...
    subType: Annotated[AccountInfoSubType | str, lenient_enum(AccountInfoSubType)] | None = Field(
...
class Profile(StrictModel):
    ...
    currencyCode: Annotated[ProfileCurrencyCode | str, lenient_enum(ProfileCurrencyCode)] | None = Field(
        default=None,
        description="""
The currency used for all monetary values for entities under this profile.
|Region|`countryCode`|Country Name|`currencyCode`|
...
""",
    ...
    timezone: Annotated[ProfileTimezone | str, lenient_enum(ProfileTimezone)] | None = Field(
        default=None,
        description="""
The time zone used for all date-based campaign management and reporting.
|Region|`countryCode`|Country Name|`timezone`|
