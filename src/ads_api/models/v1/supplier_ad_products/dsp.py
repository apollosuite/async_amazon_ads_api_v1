...
class DSPSupplierAdProductSortOptionsFields(StrEnum):
    ...
    name = "name"
    supplierAdProductId = "supplierAdProductId"


class DSPSupplierAdProductType(StrEnum):
...
class DSPSupplierAdProduct(LenientModel):
    ...
    supplierAdProductType: Annotated[DSPSupplierAdProductType | str, lenient_enum(DSPSupplierAdProductType)] | None = (
        Field(default=None)
    )
