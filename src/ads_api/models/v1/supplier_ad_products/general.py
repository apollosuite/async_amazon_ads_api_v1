...
type SupplierAdProductSortOptionsFields = Literal["name", "supplierAdProductId"]
"""
...
type SupplierAdProductType = Literal["AMAZON_MEDIA", "AMAZON_PUBLISHER_CLOUD", "AMAZON_PUBLISHER_DIRECT"]
...
class AmazonMediaSupplierAdProductExtension(LenientModel):
...
class QuerySupplierAdProductRequest(StrictModel):
    adProductFilter: SupplierAdProductAdProductFilter
    countryFilter: SupplierAdProductCountryCodeFilter | None = Field(default=None)
    dealTypeFilter: SupplierAdProductAdvertisingDealTypeFilter | None = Field(default=None)
    inventoryTypeFilter: SupplierAdProductInventoryTypeFilter | None = Field(default=None)
    maxDateTimeFilter: SupplierAdProductMaxDateTimeFilter | None = Field(default=None)
    maxResults: int | None = Field(default=10, ge=1, le=100)
    minDateTimeFilter: SupplierAdProductMinDateTimeFilter | None = Field(default=None)
    nameFilter: SupplierAdProductSupplierNameFilter | None = Field(default=None)
    nextToken: str | None = Field(default=None)
    sort: list[SupplierAdProductSortOption] | None = Field(default=None, min_length=0, max_length=2)
    supplierAdProductIdFilter: SupplierAdProductSupplierAdProductIdFilter | None = Field(default=None)
    supplierProposalDestinationIdFilter: SupplierAdProductSupplierProposalDestinationIdFilter | None = Field(
        default=None
    )
    supplierPublisherIdFilter: SupplierAdProductSupplierPublisherIdFilter | None = Field(default=None)


class SupplierAdProduct(LenientModel):
    ...
    priceType: AdvertisingDealPriceType | str | None = Field(default=None)
    supplierAdProductExtension: SupplierAdProductExtension | None = Field(default=None)
    supplierAdProductId: str = Field(description="The supplier ad product unique identifier.")
    supplierAdProductType: SupplierAdProductType | str | None = Field(default=None)
...
class SupplierAdProductAdProductFilter(StrictModel):
    include: list[AdProduct] = Field(min_length=1, max_length=1)


class SupplierAdProductAdvertisingDealTypeFilter(StrictModel):
...
class SupplierAdProductCountryCodeFilter(StrictModel):
    include: list[CountryCode] = Field(min_length=1, max_length=10)


class SupplierAdProductExtension(LenientModel):
    amazonMediaSupplierAdProductExtension: AmazonMediaSupplierAdProductExtension
...
class SupplierAdProductInventoryTypeFilter(StrictModel):
    include: list[InventoryType] = Field(min_length=1, max_length=10)


class SupplierAdProductMaxDateTimeFilter(StrictModel):
    include: list[datetime] = Field(min_length=1, max_length=2)


class SupplierAdProductMinDateTimeFilter(StrictModel):
    include: list[datetime] = Field(min_length=1, max_length=2)


class SupplierAdProductSortOption(StrictModel):
    by: SupplierAdProductSortOptionsFields
    direction: SortDirection | None = Field(default=None)


class SupplierAdProductSuccessResponse(LenientModel):
    nextToken: str | None = Field(default=None)
    supplierAdProducts: list[SupplierAdProduct] | None = Field(default=None, min_length=0, max_length=100)
    totalResults: int | None = Field(default=None)


class SupplierAdProductSupplierAdProductIdFilter(StrictModel):
    include: list[str] = Field(min_length=1, max_length=50)


class SupplierAdProductSupplierNameFilter(StrictModel):
    include: list[str] = Field(min_length=1, max_length=1)


class SupplierAdProductSupplierProposalDestinationIdFilter(StrictModel):
    include: list[str] = Field(min_length=1, max_length=10)


class SupplierAdProductSupplierPublisherIdFilter(StrictModel):
    include: list[str] = Field(min_length=1, max_length=10)
...
__all__ = [
    ...
    "AdvertisingDealType",
    "AmazonMediaSupplierAdProductExtension",
    ...
    "SortDirection",
    "SupplierAdProduct",
    "SupplierAdProductAdProductFilter",
    "SupplierAdProductAdvertisingDealTypeFilter",
    "SupplierAdProductBookingConstraints",
    "SupplierAdProductBudgetConstraints",
    "SupplierAdProductConstraints",
    "SupplierAdProductCountryCodeFilter",
    "SupplierAdProductExtension",
    "SupplierAdProductFlightConstraints",
    "SupplierAdProductFrequencyConstraints",
    "SupplierAdProductGoalConstraints",
    "SupplierAdProductGoalConstraintsExtension",
    "SupplierAdProductInventoryTypeFilter",
    "SupplierAdProductMaxDateTimeFilter",
    "SupplierAdProductMinDateTimeFilter",
    "SupplierAdProductShareOfVoiceConstraints",
    "SupplierAdProductSortOption",
    "SupplierAdProductSortOptionsFields",
    "SupplierAdProductSuccessResponse",
    "SupplierAdProductSupplierAdProductIdFilter",
    "SupplierAdProductSupplierNameFilter",
    "SupplierAdProductSupplierProposalDestinationIdFilter",
    "SupplierAdProductSupplierPublisherIdFilter",
    "SupplierAdProductTargetingConstraints",
    "SupplierAdProductType",
    "SupplierAppTarget",
