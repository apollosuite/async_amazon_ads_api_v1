...
class SBAlternateBrandIdType(StrEnum):
    ...
    BRAND_REGISTRY = "BRAND_REGISTRY"  # Previous version of brand identifier retrieved from BrandRegistry. Identifiers of this type are returned by the GET /brands operation.
