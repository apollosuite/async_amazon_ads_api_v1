...
class DSPPriceComponentType(StrEnum):
    SUPPLIER_PRICE = "SUPPLIER_PRICE"
    THIRD_PARTY_DATA_TARGETING_FEE = "THIRD_PARTY_DATA_TARGETING_FEE"


class DSPSupplierAdProductPriceDescriptionType(StrEnum):
...
class DSPCreateSupplierAdProductPriceDescription(StrictModel):
    ...
    supplierAdProductPriceDescriptionType: Annotated[
        DSPSupplierAdProductPriceDescriptionType, lenient_enum(DSPSupplierAdProductPriceDescriptionType)
    ]
...
class DSPPriceComponent(LenientModel):
    ...
    priceComponentType: Annotated[DSPPriceComponentType | str, lenient_enum(DSPPriceComponentType)]
...
class DSPSupplierAdProductPriceDescription(LenientModel):
    ...
    supplierAdProductId: str = Field(description="The supplier ad product ID.")
    supplierAdProductPriceDescriptionType: Annotated[
        DSPSupplierAdProductPriceDescriptionType | str, lenient_enum(DSPSupplierAdProductPriceDescriptionType)
    ]
    supplierProposalDestinationId: str | None = Field(
        default=None, description="The proposal supplier proposal destination ID."
    )
