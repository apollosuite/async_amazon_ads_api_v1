...
type PriceComponentType = Literal["SUPPLIER_PRICE", "THIRD_PARTY_DATA_TARGETING_FEE"]


type SupplierAdProductPriceDescriptionType = Literal["AMAZON_MEDIA"]
...
class CreateSupplierAdProductPriceDescription(StrictModel):
    ...
    supplierAdProductPriceDescriptionType: SupplierAdProductPriceDescriptionType
...
class CreateSupplierAdProductPriceRequest(StrictModel):
    supplierAdProductPrices: list[SupplierAdProductPriceCreate] = Field(min_length=1, max_length=10)
...
class PriceComponent(LenientModel):
    price: AdvertisingDealPrice
    priceComponentType: PriceComponentType | str


class SupplierAdProductPrice(LenientModel):
    itemizedPrice: list[PriceComponent] | None = Field(
    ...
    price: AdvertisingDealPrice
    supplierAdProductPriceDescription: SupplierAdProductPriceDescription


class SupplierAdProductPriceCreate(StrictModel):
    supplierAdProductPriceDescription: CreateSupplierAdProductPriceDescription


class SupplierAdProductPriceDescription(LenientModel):
    """The description of the supplier ad product price request parameters."""
    ...
    startDateTime: datetime = Field(description="Start datetime for rate calculation.")
    supplierAdProductId: str = Field(description="The supplier ad product ID.")
    supplierAdProductPriceDescriptionType: SupplierAdProductPriceDescriptionType | str
    supplierProposalDestinationId: str | None = Field(
        default=None, description="The proposal supplier proposal destination ID."
    )
...
class SupplierAdProductPriceMultiStatusResponse(LenientModel):
    error: list[ErrorsIndex] | None = Field(default=None, min_length=0, max_length=10)
    success: list[SupplierAdProductPriceMultiStatusSuccess] | None = Field(default=None, min_length=0, max_length=10)


class SupplierAdProductPriceMultiStatusSuccess(LenientModel):
    index: int = Field(ge=0, le=9)
    supplierAdProductPrice: SupplierAdProductPrice
...
__all__ = [
    ...
    "CreateFrequencyCap",
    "CreateSize",
    "CreateSupplierAdProductPriceDescription",
    ...
    "SupplierAdProductPriceCreate",
    "SupplierAdProductPriceDescription",
    "SupplierAdProductPriceDescriptionType",
    "SupplierAdProductPriceMultiStatusResponse",
    "SupplierAdProductPriceMultiStatusSuccess",
    "SupplierAppTarget",
