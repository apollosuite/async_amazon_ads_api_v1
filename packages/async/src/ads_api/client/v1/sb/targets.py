...
class SBTargets(BaseResource):
    ...
    @overload
    async def create_target(self, body: SBCreateTargetRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    ...
    @overload
    async def delete_target(self, body: SBDeleteTargetRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    ...
    @overload
    async def query_target(self, body: SBQueryTargetRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    async def query_target(
        self, body: SBQueryTargetRequest, *, mode: Literal["pydantic"]
    ) -> SBTargetSuccessResponse: ...
    @overload
    ...
    @overload
    async def update_target(self, body: SBUpdateTargetRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
