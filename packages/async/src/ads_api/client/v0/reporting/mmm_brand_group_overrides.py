...
class MmmBrandGroupOverrides(BaseResource):
    ...
    @overload
    async def create_mmm_brand_group_overrides(self, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    async def create_mmm_brand_group_overrides(self, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    async def create_mmm_brand_group_overrides(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def create_mmm_brand_group_overrides(self, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
    ...
    @overload
    async def delete_mmm_brand_group_overrides(self, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    async def delete_mmm_brand_group_overrides(self, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    async def delete_mmm_brand_group_overrides(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def delete_mmm_brand_group_overrides(self, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
    ...
    @overload
    async def list_mmm_brand_group_overrides(self, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    async def list_mmm_brand_group_overrides(self, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    async def list_mmm_brand_group_overrides(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def list_mmm_brand_group_overrides(self, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
