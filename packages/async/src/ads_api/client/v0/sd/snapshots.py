...
class Snapshots(BaseResource):
    ...
    @overload
    async def download_snapshot(self, snapshot_id: str, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    async def download_snapshot(self, snapshot_id: str, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    async def download_snapshot(self, snapshot_id: str, *, mode: Literal["raw"]) -> httpx.Response: ...
    async def download_snapshot(self, snapshot_id: str, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
        """**Note: Snapshots APIs are deprecated and will be shut off on October 15, 2024. For replacement functionality, see the [exports](guides/exports/overview) API. To learn more, view the [migration guide](reference/migration-guides/snapshots-exports).**"""
    ...
    @overload
    async def get_snapshot(self, snapshot_id: str, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    async def get_snapshot(self, snapshot_id: str, *, mode: Literal["pydantic"]) -> SnapshotResponse: ...
    @overload
