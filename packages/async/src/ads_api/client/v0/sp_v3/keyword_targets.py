...
class KeywordTargets(BaseResource):
    ...
    @overload
    async def get_global_ranked_keyword_recommendation(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    ...
    @overload
    async def get_ranked_keyword_recommendation(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    async def get_ranked_keyword_recommendation(self, *, mode: Literal["pydantic"]) -> KeywordTargetResponse: ...
    @overload
