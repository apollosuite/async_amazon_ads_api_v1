...
class BudgetRecommendationsAndMissedOpportunities(BaseResource):
    ...
    async def get_budget_recommendations(
        self, body: BudgetRecommendationRequest, *, mode: Literal["dict"] = "dict"
    ) -> dict[str, Any]: ...
    @overload
    async def get_budget_recommendations(
        self, body: BudgetRecommendationRequest, *, mode: Literal["pydantic"]
    ) -> BudgetRecommendationResponse: ...
    @overload
    async def get_budget_recommendations(
    ...
    async def get_budget_recommendations(
        self, body: BudgetRecommendationRequest, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
