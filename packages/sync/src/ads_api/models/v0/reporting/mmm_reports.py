...
class MmmReport(LenientModel):
    ...
    status: Literal["CANCELED", "FAILED", "PENDING", "PROCESSING", "SUCCEEDED"] | str | None = Field(
        default=None,
        description="""
...
class MmmReportConfiguration(LenientModel):
    ...
    geoDimension: Literal["COUNTRY", "DMA", "POSTAL_CODE"] | str = Field(description="""
...
""")
    metricsType: Literal["MEDIA_AND_SALES", "MEDIA_ONLY"] | str = Field(description="""
...
""")
    timeUnit: Literal["DAILY", "WEEKLY"] | str = Field(description="""
