...
class AdCreatives(BaseResource):
    ...
    @overload
    def create_brand_video_creative(
    ...
    @overload
    def create_extended_product_collection_creative(
    ...
    @overload
    def create_product_collection_creative(
    ...
    @overload
    def create_store_spotlight_creative(
    ...
    @overload
    def list_creatives(self, body: ListCreativesRequestContent, *, mode: Literal["raw"]) -> httpx.Response: ...
    def list_creatives(
