...
class Ads(BaseResource):
    ...
    @overload
    def create_sponsored_brand_store_spotlight_ads(
    ...
    @overload
    def create_sponsored_brands_auto_collection_ads(
    ...
    @overload
    def create_sponsored_brands_brand_video_ads(
    ...
    @overload
    def create_sponsored_brands_extended_product_collection_ads(
    ...
    @overload
    def create_sponsored_brands_manual_collection_ads(
    ...
    @overload
    def create_sponsored_brands_product_collection_ads(
    ...
    @overload
    def create_sponsored_brands_video_ads(
    ...
    @overload
    def delete_sponsored_brands_ads(
    ...
    @overload
    def update_sponsored_brands_ads(
    ...
    @overload
    def update_sponsored_brands_auto_collection_ads(
    ...
    @overload
    def update_sponsored_brands_manual_collection_ads(
