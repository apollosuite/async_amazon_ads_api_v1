...
class ProductMetadata(BaseResource):
    ...
    @overload
    def product_metadata(self, body: ProductMetadataRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def product_metadata(
        self, body: ProductMetadataRequest, *, mode: Literal["pydantic"]
    ) -> ProductMetadataResponse: ...
    @overload
    def product_metadata(self, body: ProductMetadataRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def product_metadata(
