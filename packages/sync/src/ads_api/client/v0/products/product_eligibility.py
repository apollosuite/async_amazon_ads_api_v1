...
class ProductEligibility(BaseResource):
    ...
    @overload
    def product_eligibility(self, body: ProductEligibilityRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def product_eligibility(
        ...
        resp = self._request("POST", "/eligibility/product/list", json=self.dump_json(body))
