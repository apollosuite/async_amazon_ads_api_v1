...
class CampaignNegativeKeywords(BaseResource):
    ...
    @overload
    def create_sponsored_products_campaign_negative_keywords(
        self,
    ...
    @overload
    def delete_sponsored_products_campaign_negative_keywords(
        self,
    ...
    @overload
    def list_sponsored_products_campaign_negative_keywords(
        self,
    ...
    @overload
    def update_sponsored_products_campaign_negative_keywords(
        self,
