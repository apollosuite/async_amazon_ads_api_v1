...
class ProductTargeting(BaseResource):
    ...
    @overload
    def get_category_recommendations_for_asi_ns(
        self,
    ...
    @overload
    def get_negative_brands(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_negative_brands(self, *, mode: Literal["pydantic"]) -> BrandsOut: ...
    @overload
    def get_negative_brands(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_negative_brands(
    ...
    @overload
    def get_refinements_for_category(
        self,
        category_id: str,
        *,
        accept: Literal[
    ...
    def get_refinements_for_category(
        ...
        *,
        ...
        resp = self._request("GET", f"/sp/targets/category/{category_id}/refinements", params=params, headers=headers)
        return self._response(Refinements, resp, mode=mode)

    @overload
    def get_targetable_asin_counts(
    ...
    def get_targetable_categories(
        ...
        *,
        ...
        headers = {}
        headers["Accept"] = accept
        resp = self._request("GET", "/sp/targets/categories", params=params, headers=headers)
    ...
    @overload
    def search_brands(self, body: SearchBrandsRequest | None = None, *, mode: Literal["pydantic"]) -> BrandsOut: ...
    @overload
    def search_brands(self, body: SearchBrandsRequest | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def search_brands(
