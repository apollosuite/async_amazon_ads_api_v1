...
class NegativeTargetingClauses(BaseResource):
    ...
    @overload
    def create_sponsored_products_negative_targeting_clauses(
        self,
    ...
    @overload
    def delete_sponsored_products_negative_targeting_clauses(
        self,
    ...
    @overload
    def list_sponsored_products_negative_targeting_clauses(
        self,
    ...
    @overload
    def update_sponsored_products_negative_targeting_clauses(
        self,
