...
class KeywordTargets(BaseResource):
    ...
    @overload
    def get_global_ranked_keyword_recommendation(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_global_ranked_keyword_recommendation(
        self, *, mode: Literal["pydantic"]
    ) -> GlobalRankedTargetWithThemedBidsResponse: ...
    @overload
    def get_global_ranked_keyword_recommendation(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_global_ranked_keyword_recommendation(
    ...
    @overload
    def get_ranked_keyword_recommendation(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_ranked_keyword_recommendation(self, *, mode: Literal["pydantic"]) -> KeywordTargetResponse: ...
    @overload
    def get_ranked_keyword_recommendation(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_ranked_keyword_recommendation(
        self, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
