...
class TargetPromotionGroups(BaseResource):
    ...
    @overload
    def create_target_promotion_group_targets(
    ...
    @overload
    def create_target_promotion_groups(
    ...
    @overload
    def get_target_promotion_groups_recommendations(
        self,
    ...
    @overload
    def list_target_promotion_group_targets(
        self,
    ...
    @overload
    def list_target_promotion_groups(
        self,
