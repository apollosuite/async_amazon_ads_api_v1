...
class UserInvitations(BaseResource):
    ...
    @overload
    def get_user_invitation(self, invitation_id: str, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_user_invitation(
        self, invitation_id: str, *, mode: Literal["pydantic"]
    ) -> GetUserInvitationResponseContent: ...
    @overload
    def get_user_invitation(self, invitation_id: str, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_user_invitation(
    ...
    @overload
    def redeem_user_invitation(self, body: RedeemUserInvitationRequestContent, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    def redeem_user_invitation(
