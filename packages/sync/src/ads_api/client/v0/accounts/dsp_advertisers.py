...
class DSPAdvertisers(BaseResource):
    ...
    @overload
    def get_dsp_advertiser(self, advertiser_id: str, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_dsp_advertiser(self, advertiser_id: str, *, mode: Literal["pydantic"]) -> DspAdvertiserV1: ...
    @overload
    def get_dsp_advertiser(self, advertiser_id: str, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_dsp_advertiser(
        ...
        resp = self._request("GET", f"/dsp/advertisers/{advertiser_id}")
    ...
    def list_advertisers(
        ...
        *,
        ...
        resp = self._request("GET", "/dsp/advertisers", params=params)
