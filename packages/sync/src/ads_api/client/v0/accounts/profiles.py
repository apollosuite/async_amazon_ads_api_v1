...
class Profiles(BaseResource):
    ...
    @overload
    def get_profile_by_id(self, profile_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_profile_by_id(self, profile_id: int, *, mode: Literal["pydantic"]) -> ProfileOut: ...
    @overload
    def get_profile_by_id(self, profile_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_profile_by_id(
        ...
        resp = self._request("GET", f"/v2/profiles/{profile_id}")
    ...
    def list_profiles(
        ...
        *,
        ...
        resp = self._request("GET", "/v2/profiles", params=params)
    ...
    @overload
    def update_profiles(self, body: list[Profile] | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def update_profiles(
        ...
        resp = self._request("PUT", "/v2/profiles", json=self.dump_json(body))
