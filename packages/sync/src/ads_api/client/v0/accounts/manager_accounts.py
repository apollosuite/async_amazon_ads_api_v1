...
class ManagerAccounts(BaseResource):
    ...
    @overload
    def get_manager_accounts_for_user(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_manager_accounts_for_user(self, *, mode: Literal["pydantic"]) -> GetManagerAccountsResponse: ...
    @overload
    def get_manager_accounts_for_user(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_manager_accounts_for_user(
    ...
    @overload
    def link_advertising_accounts_to_manager_account_public_api(
        self,
    ...
    @overload
    def unlink_advertising_accounts_to_manager_account_public_api(
        self,
        manager_account_id: str,
        body: UpdateAdvertisingAccountsInManagerAccountRequest,
        *,
