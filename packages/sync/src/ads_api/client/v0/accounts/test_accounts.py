...
class TestAccounts(BaseResource):
    ...
    @overload
    def create_account(self, body: CreateAccountRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def create_account(self, body: CreateAccountRequest, *, mode: Literal["pydantic"]) -> CreateAccountResponse: ...
    @overload
    def create_account(self, body: CreateAccountRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_account(
        ...
        resp = self._request("POST", "/testAccounts", json=self.dump_json(body))
    ...
    @overload
    def get_account_information(self, *, mode: Literal["raw"], request_id: str | None = None) -> httpx.Response: ...
    def get_account_information(
        ...
        resp = self._request("GET", "/testAccounts", params=params)
