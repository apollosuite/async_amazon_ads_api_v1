...
class LocationsBeta(BaseResource):
    ...
    @overload
    def archive_locations(self, body: ArchiveLocationRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def archive_locations(
        ...
        resp = self._request("POST", "/sd/locations/delete", json=self.dump_json(body))
    ...
    @overload
    def create_locations(self, body: list[CreateLocation] | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_locations(
        ...
        resp = self._request("POST", "/sd/locations", json=self.dump_json(body))
    ...
    def list_locations(
        ...
        *,
        ...
        resp = self._request("GET", "/sd/locations", params=params)
        return self._response_list(Location, resp, mode=mode)
