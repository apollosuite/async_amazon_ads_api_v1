...
class Campaigns(BaseResource):
    ...
    @overload
    def archive_campaign(self, campaign_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def archive_campaign(self, campaign_id: int, *, mode: Literal["pydantic"]) -> CampaignResponse: ...
    @overload
    def archive_campaign(self, campaign_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def archive_campaign(
        ...
        resp = self._request("DELETE", f"/sd/campaigns/{campaign_id}")
    ...
    @overload
    def create_campaigns(self, body: list[CreateCampaign] | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_campaigns(
        ...
        resp = self._request("POST", "/sd/campaigns", json=self.dump_json(body))
        return self._response_list(CampaignResponse, resp, mode=mode)

    @overload
    def get_campaign(self, campaign_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_campaign(self, campaign_id: int, *, mode: Literal["pydantic"]) -> Campaign: ...
    @overload
    def get_campaign(self, campaign_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_campaign(
        self, campaign_id: int, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
        ...
        resp = self._request("GET", f"/sd/campaigns/{campaign_id}")
        return self._response(Campaign, resp, mode=mode)

    @overload
    def get_campaign_response_ex(self, campaign_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_campaign_response_ex(self, campaign_id: int, *, mode: Literal["pydantic"]) -> CampaignResponseEx: ...
    @overload
    def get_campaign_response_ex(self, campaign_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_campaign_response_ex(
        ...
        resp = self._request("GET", f"/sd/campaigns/extended/{campaign_id}")
    ...
    def list_campaigns(
        ...
        *,
        ...
        resp = self._request("GET", "/sd/campaigns", params=params)
    ...
    def list_campaigns_ex(
        ...
        *,
        ...
        params = {k: v for k, v in params.items() if v is not None}
        resp = self._request("GET", "/sd/campaigns/extended", params=params)
    ...
    @overload
    def update_campaigns(self, body: list[UpdateCampaign] | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def update_campaigns(
        self, body: list[UpdateCampaign] | None = None, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> list[CampaignResponse] | list[dict[str, Any]] | httpx.Response:
        """"""

        resp = self._request("PUT", "/sd/campaigns", json=self.dump_json(body))
        return self._response_list(CampaignResponse, resp, mode=mode)
