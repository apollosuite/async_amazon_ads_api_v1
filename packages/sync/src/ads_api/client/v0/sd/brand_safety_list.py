...
class BrandSafetyList(BaseResource):
    ...
    def create_brand_safety_deny_list_domains(
        ...
        resp = self._request("POST", "/sd/brandSafety/deny", json=self.dump_json(body))
        return self._response(BrandSafetyUpdateResponse, resp, mode=mode)

    @overload
    def delete_brand_safety_deny_list(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def delete_brand_safety_deny_list(self, *, mode: Literal["pydantic"]) -> BrandSafetyUpdateResponse: ...
    @overload
    def delete_brand_safety_deny_list(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def delete_brand_safety_deny_list(
        ...
        resp = self._request("DELETE", "/sd/brandSafety/deny")
        return self._response(BrandSafetyUpdateResponse, resp, mode=mode)
    ...
    def get_request_results(
        ...
        *,
        ...
        resp = self._request("GET", f"/sd/brandSafety/{request_id}/results", params=params)
        return self._response(BrandSafetyRequestResultsResponse, resp, mode=mode)

    @overload
    def get_request_status(self, request_id: str, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_request_status(self, request_id: str, *, mode: Literal["pydantic"]) -> BrandSafetyRequestStatusResponse: ...
    @overload
    def get_request_status(self, request_id: str, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_request_status(
        ...
        resp = self._request("GET", f"/sd/brandSafety/{request_id}/status")
    ...
    def list_domains(
        ...
        *,
        ...
        params = {k: v for k, v in params.items() if v is not None}
        resp = self._request("GET", "/sd/brandSafety/deny", params=params)
        return self._response(BrandSafetyGetResponse, resp, mode=mode)

    @overload
    def list_request_status(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def list_request_status(self, *, mode: Literal["pydantic"]) -> BrandSafetyListRequestStatusResponse: ...
    @overload
    def list_request_status(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def list_request_status(
        ...
        resp = self._request("GET", "/sd/brandSafety/status")
