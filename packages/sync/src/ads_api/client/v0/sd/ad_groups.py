...
class AdGroups(BaseResource):
    ...
    @overload
    def archive_ad_group(self, ad_group_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def archive_ad_group(self, ad_group_id: int, *, mode: Literal["pydantic"]) -> AdGroupResponse: ...
    @overload
    def archive_ad_group(self, ad_group_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def archive_ad_group(
        ...
        resp = self._request("DELETE", f"/sd/adGroups/{ad_group_id}")
    ...
    @overload
    def create_ad_groups(self, body: list[CreateAdGroup] | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_ad_groups(
        ...
        resp = self._request("POST", "/sd/adGroups", json=self.dump_json(body))
        return self._response_list(AdGroupResponse, resp, mode=mode)

    @overload
    def get_ad_group(self, ad_group_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_ad_group(self, ad_group_id: int, *, mode: Literal["pydantic"]) -> AdGroup: ...
    @overload
    def get_ad_group(self, ad_group_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_ad_group(
        self, ad_group_id: int, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
        ...
        resp = self._request("GET", f"/sd/adGroups/{ad_group_id}")
        return self._response(AdGroup, resp, mode=mode)

    @overload
    def get_ad_group_response_ex(self, ad_group_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_ad_group_response_ex(self, ad_group_id: int, *, mode: Literal["pydantic"]) -> AdGroupResponseEx: ...
    @overload
    def get_ad_group_response_ex(self, ad_group_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_ad_group_response_ex(
        self, ad_group_id: int, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> AdGroupResponseEx | dict[str, Any] | httpx.Response:
        """"""

        resp = self._request("GET", f"/sd/adGroups/extended/{ad_group_id}")
    ...
    def list_ad_groups(
        ...
        *,
        ...
        resp = self._request("GET", "/sd/adGroups", params=params)
    ...
    def list_ad_groups_ex(
        ...
        *,
        ...
        params = {k: v for k, v in params.items() if v is not None}
        resp = self._request("GET", "/sd/adGroups/extended", params=params)
    ...
    @overload
    def update_ad_groups(self, body: list[UpdateAdGroup] | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def update_ad_groups(
        self, body: list[UpdateAdGroup] | None = None, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> list[AdGroupResponse] | list[dict[str, Any]] | httpx.Response:
        """"""

        resp = self._request("PUT", "/sd/adGroups", json=self.dump_json(body))
        return self._response_list(AdGroupResponse, resp, mode=mode)
