...
class Creatives(BaseResource):
    ...
    @overload
    def create_creatives(self, body: list[CreateCreative] | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_creatives(
        ...
        resp = self._request("POST", "/sd/creatives", json=self.dump_json(body))
    ...
    def list_creative_moderations(
        ...
        *,
        ...
        resp = self._request("GET", "/sd/moderation/creatives", params=params)
    ...
    def list_creatives(
        ...
        *,
        ...
        params = {k: v for k, v in params.items() if v is not None}
        resp = self._request("GET", "/sd/creatives", params=params)
    ...
    def post_creative_preview(
        ...
        resp = self._request("POST", "/sd/creatives/preview", json=self.dump_json(body))
    ...
    @overload
    def update_creatives(self, body: list[CreativeUpdate] | None = None, *, mode: Literal["raw"]) -> httpx.Response: ...
    def update_creatives(
        self, body: list[CreativeUpdate] | None = None, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> list[CreativeResponse] | list[dict[str, Any]] | httpx.Response:
        """"""

        resp = self._request("PUT", "/sd/creatives", json=self.dump_json(body))
        return self._response_list(CreativeResponse, resp, mode=mode)
