...
class BudgetRules(BaseResource):
    ...
    @overload
    def create_associated_budget_rules_for_sd_campaigns(
    ...
    def create_associated_budget_rules_for_sd_campaigns(
        ...
        *,
        ...
        resp = self._request("POST", f"/sd/campaigns/{campaign_id}/budgetRules", json=self.dump_json(body))
        return self._response(CreateAssociatedBudgetRulesResponse, resp, mode=mode)

    @overload
    def create_budget_rules_for_sd_campaigns(
        self, body: CreateSDBudgetRulesRequest, *, mode: Literal["dict"] = "dict"
    ) -> dict[str, Any]: ...
    @overload
    def create_budget_rules_for_sd_campaigns(
        self, body: CreateSDBudgetRulesRequest, *, mode: Literal["pydantic"]
    ) -> CreateBudgetRulesResponse: ...
    @overload
    def create_budget_rules_for_sd_campaigns(
    ...
    def create_budget_rules_for_sd_campaigns(
        self, body: CreateSDBudgetRulesRequest, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> CreateBudgetRulesResponse | dict[str, Any] | httpx.Response:
        """"""

        resp = self._request("POST", "/sd/budgetRules", json=self.dump_json(body))
        return self._response(CreateBudgetRulesResponse, resp, mode=mode)

    @overload
    def disassociate_associated_budget_rule_for_sd_campaigns(
    ...
    def disassociate_associated_budget_rule_for_sd_campaigns(
        ...
        resp = self._request("DELETE", f"/sd/campaigns/{campaign_id}/budgetRules/{budget_rule_id}")
    ...
    def get_budget_rule_by_rule_id_for_sd_campaigns(
        ...
        resp = self._request("GET", f"/sd/budgetRules/{budget_rule_id}")
        return self._response(GetSDBudgetRuleResponse, resp, mode=mode)

    @overload
    def get_campaigns_associated_with_sd_budget_rule(
    ...
    def get_campaigns_associated_with_sd_budget_rule(
        ...
        *,
        ...
        resp = self._request("GET", f"/sd/budgetRules/{budget_rule_id}/campaigns", params=params)
    ...
    def get_sd_budget_rules_for_advertiser(
        ...
        params = {k: v for k, v in params.items() if v is not None}
        resp = self._request("GET", "/sd/budgetRules", params=params)
        return self._response(GetSDBudgetRulesForAdvertiserResponse, resp, mode=mode)

    @overload
    def list_associated_budget_rules_for_sd_campaigns(
    ...
    def list_associated_budget_rules_for_sd_campaigns(
        ...
        resp = self._request("GET", f"/sd/campaigns/{campaign_id}/budgetRules")
        return self._response(SDListAssociatedBudgetRulesResponse, resp, mode=mode)

    @overload
    def update_budget_rules_for_sd_campaigns(
        self, body: UpdateSDBudgetRulesRequest, *, mode: Literal["dict"] = "dict"
    ) -> dict[str, Any]: ...
    @overload
    def update_budget_rules_for_sd_campaigns(
        self, body: UpdateSDBudgetRulesRequest, *, mode: Literal["pydantic"]
    ) -> UpdateBudgetRulesResponse: ...
    @overload
    def update_budget_rules_for_sd_campaigns(
    ...
    def update_budget_rules_for_sd_campaigns(
        self, body: UpdateSDBudgetRulesRequest, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> UpdateBudgetRulesResponse | dict[str, Any] | httpx.Response:
        """"""

        resp = self._request("PUT", "/sd/budgetRules", json=self.dump_json(body))
