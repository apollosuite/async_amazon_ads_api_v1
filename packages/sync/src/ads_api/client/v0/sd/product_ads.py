...
class ProductAds(BaseResource):
    ...
    @overload
    def archive_product_ad(self, ad_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def archive_product_ad(self, ad_id: int, *, mode: Literal["pydantic"]) -> ProductAdResponse: ...
    @overload
    def archive_product_ad(self, ad_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def archive_product_ad(
        ...
        resp = self._request("DELETE", f"/sd/productAds/{ad_id}")
    ...
    def create_product_ads(
        ...
        resp = self._request("POST", "/sd/productAds", json=self.dump_json(body))
        return self._response_list(ProductAdResponse, resp, mode=mode)

    @overload
    def get_product_ad(self, ad_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_product_ad(self, ad_id: int, *, mode: Literal["pydantic"]) -> ProductAd: ...
    @overload
    def get_product_ad(self, ad_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_product_ad(
        self, ad_id: int, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
        ...
        resp = self._request("GET", f"/sd/productAds/{ad_id}")
        return self._response(ProductAd, resp, mode=mode)

    @overload
    def get_product_ad_response_ex(self, ad_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_product_ad_response_ex(self, ad_id: int, *, mode: Literal["pydantic"]) -> ProductAdResponseEx: ...
    @overload
    def get_product_ad_response_ex(self, ad_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_product_ad_response_ex(
        self, ad_id: int, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> ProductAdResponseEx | dict[str, Any] | httpx.Response:
        """"""

        resp = self._request("GET", f"/sd/productAds/extended/{ad_id}")
    ...
    def list_product_ads(
        ...
        *,
        ...
        resp = self._request("GET", "/sd/productAds", params=params)
    ...
    def list_product_ads_ex(
        ...
        *,
        ...
        params = {k: v for k, v in params.items() if v is not None}
        resp = self._request("GET", "/sd/productAds/extended", params=params)
    ...
    def update_product_ads(
        ...
        resp = self._request("PUT", "/sd/productAds", json=self.dump_json(body))
        return self._response_list(ProductAdResponse, resp, mode=mode)
