...
class OptimizationRulesBeta(BaseResource):
    ...
    def associate_optimization_rules_with_ad_group(
        ...
        *,
        ...
        resp = self._request("POST", f"/sd/adGroups/{ad_group_id}/optimizationRules", json=self.dump_json(body))
    ...
    def create_optimization_rules(
        ...
        resp = self._request("POST", "/sd/optimizationRules", json=self.dump_json(body))
        return self._response_list(OptimizationRuleResponse, resp, mode=mode)
    ...
    @overload
    def get_ad_groups_optimization_rule(
    ...
    @overload
    def get_ad_groups_optimization_rule(self, ad_group_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_ad_groups_optimization_rule(
        ...
        resp = self._request("GET", f"/sd/adGroups/{ad_group_id}/optimizationRules")
        return self._response_list(OptimizationRule, resp, mode=mode)

    @overload
    def get_optimization_rule(self, optimization_rule_id: str, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_optimization_rule(self, optimization_rule_id: str, *, mode: Literal["pydantic"]) -> OptimizationRule: ...
    @overload
    def get_optimization_rule(self, optimization_rule_id: str, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_optimization_rule(
        ...
        resp = self._request("GET", f"/sd/optimizationRules/{optimization_rule_id}")
    ...
    def list_optimization_rules(
        ...
        *,
        ...
        resp = self._request("GET", "/sd/optimizationRules", params=params)
        return self._response_list(OptimizationRule, resp, mode=mode)
    ...
    def update_optimization_rules(
        ...
        resp = self._request("PUT", "/sd/optimizationRules", json=self.dump_json(body))
        return self._response_list(OptimizationRuleResponse, resp, mode=mode)
