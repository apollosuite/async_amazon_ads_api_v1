...
class NegativeTargeting(BaseResource):
    ...
    @overload
    def archive_negative_targeting_clause(self, negative_target_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def archive_negative_targeting_clause(
        ...
        resp = self._request("DELETE", f"/sd/negativeTargets/{negative_target_id}")
    ...
    def create_negative_targeting_clauses(
        ...
        *,
        ...
        resp = self._request("POST", "/sd/negativeTargets", json=self.dump_json(body))
        return self._response_list(TargetResponse, resp, mode=mode)

    @overload
    def get_negative_targets(self, negative_target_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_negative_targets(
        self, negative_target_id: int, *, mode: Literal["pydantic"]
    ) -> NegativeTargetingClause: ...
    @overload
    def get_negative_targets(self, negative_target_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_negative_targets(
        self, negative_target_id: int, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
        ...
        resp = self._request("GET", f"/sd/negativeTargets/{negative_target_id}")
        return self._response(NegativeTargetingClause, resp, mode=mode)

    @overload
    def get_negative_targets_ex(self, negative_target_id: int, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_negative_targets_ex(
        self, negative_target_id: int, *, mode: Literal["pydantic"]
    ) -> NegativeTargetingClauseEx: ...
    @overload
    def get_negative_targets_ex(self, negative_target_id: int, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_negative_targets_ex(
        self, negative_target_id: int, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
        ...
        resp = self._request("GET", f"/sd/negativeTargets/extended/{negative_target_id}")
    ...
    def list_negative_targeting_clauses(
        ...
        *,
        ...
        resp = self._request("GET", "/sd/negativeTargets", params=params)
    ...
    def list_negative_targeting_clauses_ex(
        ...
        *,
        ...
        params = {k: v for k, v in params.items() if v is not None}
        resp = self._request("GET", "/sd/negativeTargets/extended", params=params)
    ...
    def update_negative_targeting_clauses(
        ...
        *,
        ...
        resp = self._request("PUT", "/sd/negativeTargets", json=self.dump_json(body))
        return self._response_list(TargetResponse, resp, mode=mode)
