...
class Exports(BaseResource):
    ...
    @overload
    def ad_export(self, body: BaseUniversalApiExportRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def ad_export(
        self, body: BaseUniversalApiExportRequest, *, mode: Literal["pydantic"]
    ) -> UniversalApiExportResponse: ...
    @overload
    def ad_export(self, body: BaseUniversalApiExportRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def ad_export(
    ...
    @overload
    def ad_group_export(self, body: BaseUniversalApiExportRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def ad_group_export(
        self, body: BaseUniversalApiExportRequest, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> UniversalApiExportResponse | dict[str, Any] | httpx.Response:
    ...
    @overload
    def campaign_export(self, body: BaseUniversalApiExportRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def campaign_export(
        self, body: BaseUniversalApiExportRequest, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> UniversalApiExportResponse | dict[str, Any] | httpx.Response:
    ...
    def get_export(
        ...
        *,
        ...
        resp = self._request("GET", f"/exports/{export_id}", headers=headers)
        return self._response(UniversalApiExportResponse, resp, mode=mode)
    ...
    @overload
    def target_export(self, body: TargetsUniversalApiExportRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def target_export(
