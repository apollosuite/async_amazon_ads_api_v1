...
class MmmBrandGroups(BaseResource):
    ...
    @overload
    def get_mmm_brand_group_campaigns(
    ...
    def get_mmm_brand_group_campaigns(
        ...
        *,
        ...
        resp = self._request("GET", "/mmm/v1/brandGroups/{brandGroupId}/campaigns", params=params)
        if mode == "raw":
            return resp
        return resp.json()

    @overload
    def get_mmm_brand_group_products(
        self, *, mode: Literal["dict"] = "dict", next_token: str | None = None, max_results: int | None = None
    ) -> Any: ...
    @overload
    def get_mmm_brand_group_products(
    ...
    def get_mmm_brand_group_products(
        ...
        *,
        ...
        params = {k: v for k, v in params.items() if v is not None}
        resp = self._request("GET", "/mmm/v1/brandGroups/{brandGroupId}/products", params=params)
        if mode == "raw":
            return resp
        return resp.json()

    @overload
    def list_mmm_brand_groups(self, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    def list_mmm_brand_groups(self, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    def list_mmm_brand_groups(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def list_mmm_brand_groups(self, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
        ...
        resp = self._request("POST", "/mmm/v1/brandGroups/list")
        if mode == "raw":
            return resp
        return resp.json()
