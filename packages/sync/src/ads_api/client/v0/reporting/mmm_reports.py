...
class MmmReports(BaseResource):
    ...
    @overload
    def create_mmm_report(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def create_mmm_report(self, *, mode: Literal["pydantic"]) -> MmmReport: ...
    @overload
    def create_mmm_report(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_mmm_report(
        ...
        resp = self._request("POST", "/mmm/v1/reports")
        return self._response(MmmReport, resp, mode=mode)

    @overload
    def delete_mmm_report(self, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    def delete_mmm_report(self, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    def delete_mmm_report(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def delete_mmm_report(self, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
        """Deletes a report by ID. Use this operation to cancel or clean up a report."""

        resp = self._request("DELETE", "/mmm/v1/reports/{reportId}")
        if mode == "raw":
            return resp
        return resp.json()

    @overload
    def get_mmm_report(self, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def get_mmm_report(self, *, mode: Literal["pydantic"]) -> MmmReport: ...
    @overload
    def get_mmm_report(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def get_mmm_report(
        self, *, mode: Literal["pydantic", "dict", "raw"] = "dict"
    ) -> MmmReport | dict[str, Any] | httpx.Response:
        ...
        resp = self._request("GET", "/mmm/v1/reports/{reportId}")
        return self._response(MmmReport, resp, mode=mode)

    @overload
    def list_mmm_reports(self, *, mode: Literal["dict"] = "dict") -> Any: ...
    @overload
    def list_mmm_reports(self, *, mode: Literal["pydantic"]) -> Any: ...
    @overload
    def list_mmm_reports(self, *, mode: Literal["raw"]) -> httpx.Response: ...
    def list_mmm_reports(self, *, mode: Literal["pydantic", "dict", "raw"] = "dict") -> Any:
        ...
        resp = self._request("POST", "/mmm/v1/reports/list")
        if mode == "raw":
            return resp
        return resp.json()
