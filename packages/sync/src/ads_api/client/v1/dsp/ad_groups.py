...
class DSPAdGroups(BaseResource):
    ...
    @overload
    def create_ad_group(self, body: DSPCreateAdGroupRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def create_ad_group(
        self, body: DSPCreateAdGroupRequest, *, mode: Literal["pydantic"]
    ) -> DSPAdGroupMultiStatusResponse: ...
    @overload
    def create_ad_group(self, body: DSPCreateAdGroupRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_ad_group(
    ...
    @overload
    def query_ad_group(self, body: DSPQueryAdGroupRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def query_ad_group(
        self, body: DSPQueryAdGroupRequest, *, mode: Literal["pydantic"]
    ) -> DSPAdGroupSuccessResponse: ...
    @overload
    def query_ad_group(self, body: DSPQueryAdGroupRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def query_ad_group(
    ...
    @overload
    def update_ad_group(self, body: DSPUpdateAdGroupRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def update_ad_group(
        self, body: DSPUpdateAdGroupRequest, *, mode: Literal["pydantic"]
    ) -> DSPAdGroupMultiStatusResponse: ...
    @overload
    def update_ad_group(self, body: DSPUpdateAdGroupRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def update_ad_group(
