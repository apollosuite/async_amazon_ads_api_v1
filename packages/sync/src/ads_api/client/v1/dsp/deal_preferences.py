...
class DSPDealPreferences(BaseResource):
    ...
    def create_deal_preference(
        ...
        resp = self._request("POST", "/adsApi/v1/create/dealPreferences", json=self.dump_json(body))
        return self._response(DSPDealPreferenceMultiStatusResponse, resp, mode=mode)

    @overload
    def list_deal_preference(
    ...
    def list_deal_preference(
        ...
        *,
        ...
        resp = self._request("GET", "/adsApi/v1/dealPreferences", params=params)
