...
class DSPGeoLocations(BaseResource):
    ...
    @overload
    def create_geo_location(self, body: DSPCreateGeoLocationRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_geo_location(
        ...
        resp = self._request("POST", "/adsApi/v1/create/geoLocations", json=self.dump_json(body))
