...
class DSPSupplierProposals(BaseResource):
    ...
    def create_supplier_proposal(
        ...
        resp = self._request("POST", "/adsApi/v1/create/supplierProposals", json=self.dump_json(body))
        return self._response(DSPSupplierProposalMultiStatusResponse, resp, mode=mode)

    @overload
    def query_supplier_proposal(
    ...
    def query_supplier_proposal(
        ...
        resp = self._request("POST", "/adsApi/v1/query/supplierProposals", json=self.dump_json(body))
        return self._response(DSPSupplierProposalSuccessResponse, resp, mode=mode)

    @overload
    def update_supplier_proposal(
    ...
    def update_supplier_proposal(
        ...
        resp = self._request("POST", "/adsApi/v1/update/supplierProposals", json=self.dump_json(body))
        return self._response(DSPSupplierProposalMultiStatusResponse, resp, mode=mode)
