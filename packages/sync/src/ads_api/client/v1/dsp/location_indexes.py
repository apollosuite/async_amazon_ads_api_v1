...
class DSPLocationIndexes(BaseResource):
    ...
    @overload
    def create_location_index(self, body: DSPCreateLocationIndexRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def create_location_index(
        ...
        resp = self._request("POST", "/adsApi/v1/create/locationIndexes", json=self.dump_json(body))
        return self._response(DSPLocationIndexMultiStatusResponse, resp, mode=mode)

    @overload
    def list_location_index(
    ...
    def list_location_index(
        ...
        *,
        ...
        resp = self._request("GET", "/adsApi/v1/locationIndexes", params=params)
        return self._response(DSPLocationIndexSuccessResponse, resp, mode=mode)

    @overload
    def retrieve_location_index(
    ...
    def retrieve_location_index(
        ...
        resp = self._request("POST", "/adsApi/v1/retrieve/locationIndexes", json=self.dump_json(body))
        return self._response(DSPLocationIndexMultiStatusResponse, resp, mode=mode)

    @overload
    def update_location_index(
    ...
    @overload
    def update_location_index(self, body: DSPUpdateLocationIndexRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def update_location_index(
        ...
        resp = self._request("POST", "/adsApi/v1/update/locationIndexes", json=self.dump_json(body))
        return self._response(DSPLocationIndexMultiStatusResponse, resp, mode=mode)
