...
class DSPSupplierProposedDeals(BaseResource):
    ...
    @overload
    def create_supplier_proposed_deal(
    ...
    def create_supplier_proposed_deal(
        ...
        resp = self._request("POST", "/adsApi/v1/create/supplierProposedDeals", json=self.dump_json(body))
        return self._response(DSPSupplierProposedDealMultiStatusResponse, resp, mode=mode)

    @overload
    def query_supplier_proposed_deal(
    ...
    def query_supplier_proposed_deal(
        ...
        resp = self._request("POST", "/adsApi/v1/query/supplierProposedDeals", json=self.dump_json(body))
        return self._response(DSPSupplierProposedDealSuccessResponse, resp, mode=mode)

    @overload
    def update_supplier_proposed_deal(
    ...
    def update_supplier_proposed_deal(
        ...
        resp = self._request("POST", "/adsApi/v1/update/supplierProposedDeals", json=self.dump_json(body))
        return self._response(DSPSupplierProposedDealMultiStatusResponse, resp, mode=mode)
