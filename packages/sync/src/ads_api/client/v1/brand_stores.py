...
class BrandStores(BaseResource):
    ...
    @overload
    def query_brand_store(self, body: QueryBrandStoreRequest, *, mode: Literal["dict"] = "dict") -> dict[str, Any]: ...
    @overload
    def query_brand_store(
        self, body: QueryBrandStoreRequest, *, mode: Literal["pydantic"]
    ) -> BrandStoreSuccessResponse: ...
    @overload
    def query_brand_store(self, body: QueryBrandStoreRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def query_brand_store(
        ...
        resp = self._request("POST", "/adsApi/v1/query/brandStores", json=self.dump_json(body))
