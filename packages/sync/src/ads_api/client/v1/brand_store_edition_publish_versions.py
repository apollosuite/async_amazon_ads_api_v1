...
class BrandStoreEditionPublishVersions(BaseResource):
    ...
    @overload
    def query_brand_store_edition_publish_version(
    ...
    def query_brand_store_edition_publish_version(
        ...
        resp = self._request("POST", "/adsApi/v1/query/brandStoreEditionPublishVersions", json=self.dump_json(body))
        return self._response(BrandStoreEditionPublishVersionSuccessResponse, resp, mode=mode)

    @overload
    def update_brand_store_edition_publish_version(
    ...
    def update_brand_store_edition_publish_version(
        ...
        resp = self._request("POST", "/adsApi/v1/update/brandStoreEditionPublishVersions", json=self.dump_json(body))
