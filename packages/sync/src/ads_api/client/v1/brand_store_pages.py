...
class BrandStorePages(BaseResource):
    ...
    @overload
    def query_brand_store_page(self, body: QueryBrandStorePageRequest, *, mode: Literal["raw"]) -> httpx.Response: ...
    def query_brand_store_page(
        ...
        resp = self._request("POST", "/adsApi/v1/query/brandStorePages", json=self.dump_json(body))
