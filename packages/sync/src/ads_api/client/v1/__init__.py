"""Amazon Ads API v1 synchronous client."""
...
class AdsClientV1:
    """Synchronous client for Amazon Ads API v1.

    Ad products are nested; unscoped APIs hang off the client:

        with AdsClientV1(config) as ads:
            ads.sp.campaigns.create_campaign(body)
            ads.selling_accounts.query_selling_account(body)
    """
    ...
    def __enter__(self) -> AdsClientV1:
        return self
