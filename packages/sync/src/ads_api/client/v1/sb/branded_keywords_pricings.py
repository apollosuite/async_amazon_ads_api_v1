"""SBBrandedKeywordsPricings resource operations.
...
from ads_api.models.v1.branded_keywords_pricings.sb import (
    SBBrandedKeywordsPricingMultiStatusResponse,
    SBCreateBrandedKeywordsPricingRequest,
)


class SBBrandedKeywordsPricings(BaseResource):

    @overload
    def create_branded_keywords_pricing(
    ...
    def create_branded_keywords_pricing(
        ...
        resp = self._request("POST", "/adsApi/v1/create/brandedKeywordsPricings/sb", json=self.dump_json(body))
