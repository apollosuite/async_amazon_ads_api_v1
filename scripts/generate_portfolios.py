...
MODELS_OUTPUT = HERE.parent / "src" / "async_amazon_ads_api_v1" / "models" / "legacy" / "portfolios.py"
...
def main() -> None:
    ...
    # Collect schemas referenced by all endpoints
    ...
    lines: list[str] = []
    lines.append('"""Portfolio Pydantic models — generated from Portfolios_prod_3p.json."""')
    lines.append("")
